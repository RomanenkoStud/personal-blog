...
('About', 'about',
'{"heroName":"Hi, I''m Pavlo.","heroBio":"I''m a frontend engineer in Munich who cares more about systems than frameworks. This is where I write about the architecture, tools, and home-lab tinkering behind the work.","heroTagline":"frontend engineer · systems & architecture · munich","heroPhoto":"/img5.jpg","tagline":"Lean engineering: simple systems, made on purpose.","bio":"Frontend developer with a focus on architecture and internal tooling. I don''t just build features — I build the systems that help teams scale. Design systems, centralized localization, and micro-frontend structures in multi-repo environments.","photo":"/img3.jpg","location":"munich · remote","whatIDo":["Architecture — design systems, localization, micro-frontends","Dev efficiency — AI agents (Claude, Copilot) in coding & testing","Ownership — refactoring legacy, automating pipelines, clean code"],"experience":[{"title":"Frontend Developer · Pragmasoft","startDate":"2023-08","endDate":"","location":"hybrid"}],"education":[{"title":"B.Sc. Computer Engineering · KhNURE","startDate":"2020-09","endDate":"2024-06","location":""}],"tech":["TypeScript","Angular","React","Next.js","Astro","Web Components","Python","AWS","CI/CD","Keycloak"],"cta":"Open to senior roles — Munich & remote."}',
